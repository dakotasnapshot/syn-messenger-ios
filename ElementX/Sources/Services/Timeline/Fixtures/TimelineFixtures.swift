...
enum TimelineFixtures {
    static var appStoreConversation: [RoomTimelineItemProtocol] {
        [TextRoomTimelineItem(text: "Want to try the lakeside trail?", senderDisplayName: "Maya"),
         TextRoomTimelineItem(text: "Absolutely. I can bring snacks.", senderDisplayName: "Alice"),
         TextRoomTimelineItem(text: "Trailhead at 9 works for me!", senderDisplayName: "Maya")]
    }
