...
nonisolated struct NotificationToneManager: NotificationToneManagerProtocol {
    ...
    /// The default SYN Messenger bundled message tone.
    static let defaultElementXMessageTone: NotificationTone = .createBundledSound(label: NSLocalizedString("screen_notification_settings_sound_syn_default",
                                                                                                           tableName: "Untranslated",
                                                                                                           bundle: .app,
                                                                                                           value: "SYN Default",
                                                                                                           comment: "Default SYN notification sound"),
                                                                                  filename: "message.caf")
    
    /// All default tones (system + SYN Messenger), sorted by name.
    ...
    /// SYN Messenger bundled tones available for selection, sorted by name.
    private static let defaultElementXAlerts: [NotificationTone] = [
        defaultElementXMessageTone,
        .createBundledSound(label: NSLocalizedString("screen_notification_settings_sound_syn_fade",
                                                     tableName: "Untranslated",
                                                     bundle: .app,
                                                     value: "SYN Fade",
                                                     comment: "SYN fade notification sound"),
