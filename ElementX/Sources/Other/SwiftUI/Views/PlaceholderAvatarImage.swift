...
struct PlaceholderAvatarImage: View {
        ...
        GeometryReader { geometry in
            ZStack(alignment: .center) {
                ...
                if redactionReasons != .placeholder {
                    Text(textForImage)
                        .foregroundColor(foregroundColorOverride ?? avatarColor?.text ?? .white)
    ...
    init(name: String?, contentID: String, backgroundColor: Color? = nil, foregroundColor: Color? = nil) {
    ...
    private var backgroundColor: Color {
        ...
        return backgroundColorOverride ?? avatarColor?.background ?? .compound.iconPrimary
    }
