...
enum SYNPresenceMode: String, CaseIterable, Codable, Identifiable {
    case automatic
    case online
    case unavailable
    case offline
...
final nonisolated class AppSettings: @unchecked Sendable {
    ...
    let backgroundAppRefreshTaskIdentifier = "app.syn.messenger.background.refresh"
    
    /// A URL where users can go read more about the app.
    private(set) var websiteURL: URL = "https://synmessenger.com"
    /// A URL that contains the app's logo that may be used when showing content in a web view.
    private(set) var logoURL: URL = "https://synmessenger.com/logo.svg"
    /// A URL that contains that app's copyright notice.
    private(set) var copyrightURL: URL = "https://synmessenger.com/copyright.html"
    /// A URL that contains the app's Terms of use.
    private(set) var acceptableUseURL: URL = "https://synmessenger.com/terms.html"
    /// A URL that contains the app's Privacy Policy.
    private(set) var privacyURL: URL = "https://synmessenger.com/privacy.html"
    ...
    @UserPreference(defaultValue: SYNColorMode.system)
    var synColorMode: SYNColorMode
    
    @UserPreference
    var customThemeData: Data?
    ...
    private(set) nonisolated(unsafe) var oAuthRedirectURL: URL! = URL(string: "https://synmessenger.com/oauth/ios/\(InfoPlistReader.main.bundleIdentifier)")
    ...
    private(set) var pushGatewayBaseURL: URL = "https://push.synmessenger.com"
    ...
    var notificationMentionKeywords: [String]
    ...
    static let bundledMapTilerConfiguration = MapTilerConfiguration(baseURL: "syn-map://bundled",
                                                                    apiKey: "",
                                                                    lightStyleID: "SYNMapLight",
                                                                    darkStyleID: "SYNMapDark")
    ...
    @UserPreference(defaultValue: SYNPresenceMode.automatic)
    var synPresenceMode: SYNPresenceMode
    
    @UserPreference(defaultValue: "")
    var synPresenceStatusMessage: String
