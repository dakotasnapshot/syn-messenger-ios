...
struct UserProfileScreenViewState: BindableState {
    ...
    var presence: ClientProxyPresenceInfo?
    ...
    var presenceText: String? {
        ...
        let availability = switch presence.presence {
        ...
        guard let statusMessage = presence.statusMessage, !statusMessage.isEmpty else {
            return availability
        }
