    ...
    func body(content: Content) -> some View {
        content
            ...
            .overlay(alignment: .top) {
                LinearGradient(colors: [.blue.opacity(0.72), Color(red: 0.08, green: 0.04, blue: 0.20), .clear],
                               startPoint: .top,
...
private struct OldBloomModifier: ViewModifier {
    ...
    private func canUse(_ bloom: Bloom) -> Bool {
        ...
        bloom.colorScheme == colorScheme && bloom.baseColor == .blue
    }
