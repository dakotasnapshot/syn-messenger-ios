...
class SettingsScreenViewModel: SettingsScreenViewModelType, SettingsScreenViewModelProtocol {
    ...
    init(userSession: UserSessionProtocol, appSettings: AppSettings, isBugReportServiceEnabled: Bool, isInSecondaryWindow: Bool, userIndicatorController: UserIndicatorControllerProtocol) {
        ...
        super.init(initialViewState: .init(deviceID: userSession.clientProxy.deviceID,
                                           ...
                                           bindings: .init(sharePresence: appSettings.sharePresence,
                                                           synPresenceMode: appSettings.synPresenceMode,
                                                           synPresenceStatusMessage: appSettings.synPresenceStatusMessage)),
    ...
    override func process(viewAction: SettingsScreenViewAction) {
        ...
        case .updateSharePresence(let value):
            appSettings.sharePresence = value
            state.bindings.sharePresence = value
        case .updatePresenceMode(let mode):
            appSettings.synPresenceMode = mode
            state.bindings.synPresenceMode = mode
        case .updatePresenceStatusMessage(let message):
            appSettings.synPresenceStatusMessage = message
            state.bindings.synPresenceStatusMessage = message
        case .linkNewDevice:
