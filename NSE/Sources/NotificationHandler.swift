...
nonisolated class NotificationHandler {
    ...
    func processEvent(_ eventID: String, roomID: String) async {
        ...
        let deliveredNotificationCount = await UNUserNotificationCenter.current()
            .deliveredNotifications()
            .filter { $0.request.content.receiverID == notificationContent.receiverID }
            .count
        notificationContent.badge = notificationContent.badgeCount(existingDeliveredNotificationCount: deliveredNotificationCount) as NSNumber
    ...
    private func discardNotification() {
        ...
        content.badge = notificationContent.badge
